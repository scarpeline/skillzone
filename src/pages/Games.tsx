...
const games = [
  {
    id: "fortune-ox",
    name: "Fortune Ox",
    description: "O Boi da Fortuna traz multiplicadores explosivos! 3 scatters ativam 10 Free Spins com multiplicador crescente.",
    players: "31,400",
    tournaments: "12",
    activeTournaments: 2,
    icon: "🐂",
  ...
  },
  {
    ...
    description: "Zeus lança multiplicadores do céu! Cluster pays 6x5, tumble infinito e 15 Free Spins com multiplicadores acumulados.",
    players: "52,800",
    tournaments: "18",
    activeTournaments: 4,
    icon: "⚡",
