...
const Rankings = () => {
  ...
  const fetchRankings = async (gameId: string) => {
    ...
    const { data } = await supabase
      .from("profiles")
      .select("id, user_id, username, display_name, xp, total_matches, total_wins, total_earnings, vip_level, credits_balance")
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                      ...
                      <div className="order-1">
                        <div className="bg-card rounded-xl border-2 border-gray-300/50 p-2 md:p-4 text-center mt-4 md:mt-8">
                          <div className="w-10 h-10 md:w-16 md:h-16 mx-auto rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center font-display font-bold text-sm md:text-xl text-gray-800 mb-1 md:mb-2">{rankings[1].avatar}</div>
                      ...
                      <div className="order-2">
                        <div className="bg-gradient-to-br from-amber-500/20 to-amber-600/10 rounded-xl border-2 border-amber-400/50 p-2 md:p-4 text-center">
                          <div className="w-12 h-12 md:w-20 md:h-20 mx-auto rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center font-display font-bold text-lg md:text-2xl text-amber-900 mb-1 md:mb-2 ring-2 md:ring-4 ring-amber-400/50">{rankings[0].avatar}</div>
                      ...
                      <div className="order-3">
                        <div className="bg-card rounded-xl border-2 border-amber-600/50 p-2 md:p-4 text-center mt-6 md:mt-12">
                          <div className="w-8 h-8 md:w-14 md:h-14 mx-auto rounded-full bg-gradient-to-br from-amber-600 to-amber-800 flex items-center justify-center font-display font-bold text-xs md:text-lg text-amber-100 mb-1 md:mb-2">{rankings[2].avatar}</div>
